...
# Load data from file
data = np.loadtxt('lux.csv', delimiter=',', skiprows=1)
...
command = 'timidity -Ow -A120 -EFreverb=0.8 -EFchorus=0.8,0.7,130 -EFflanger=0.8,0.65,0.5 lux.mid -o - | ffmpeg -i - ' \
          '-acodec libmp3lame -ab 64k lux_ghostly.mp3'
